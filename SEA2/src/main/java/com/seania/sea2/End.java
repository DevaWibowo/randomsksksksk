...
public class End extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Untuk saat ini developent belum dikembangkan");

        jLabel2.setText("sehingga cerita akan bersambung...");

        jLabel3.setText("terima kasih telah menyempatkan waktu^^");
